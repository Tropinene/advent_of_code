# Copy from https://github.com/kodsnack/advent_of_code_2016/blob/master/advall-python/d11.py
...
if __name__ == '__main__':
    ...
    inputFileSrc = "input.txt"
    allConsideredStates = set()
    print("[Part1] : " + str(solve()))

    part2 = True
    allConsideredStates = set()
    print("[Part2] : " + str(solve()))
